    ...
    public class Utils
    {
        ...
        public static void AddCameraTextureHelper()
        {
            ...
            if (cth.inputTextures == null || cth.inputTextures.Length == 0)
            {
                ...
                InputTexture inputTexture = (InputTexture)AssetDatabase.LoadAssetAtPath(inputTexturePath, typeof(InputTexture));
                cth.inputTextures = new InputTexture[1] { inputTexture };
            }
#endif
        }
